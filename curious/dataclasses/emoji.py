...
class Emoji(Dataclass):
    ...
    async def edit(self, *,
        ...
        await current_bot.get().http.edit_guild_emoji(guild_id=self.guild_id, emoji_id=self.id,
    ...
    async def delete(self) -> None:
        ...
        Deletes this emoji.
        """
        await current_bot.get().http.delete_guild_emoji(self.guild_id, emoji_id=self.id)
